...
def Data_Description (All_data1, All_data2): 
    ...
    ##### II. Find the average/min/max number of entries per observation.
    ...
    ## Find the max,min,averge number of entries per observation based on the data2 file
    ...
    ##### III. Add a column in data2 dataframe to indicate the number of entries per observation.
...
DF_data2_1 = spark.read.csv(Path_data2_1)
DF_data2_2 = spark.read.csv(Path_data2_2)
